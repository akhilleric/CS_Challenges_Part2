...
namespace CS_036_SlotMachine
{
    public partial class SlotLayout : System.Web.UI.Page
    {
        ...
        {
            if (reels[0] == "Seven" && reels[1] == "Seven" && reels[2] == "Sevel")
                return true;
            else
                return false;
        }
        ...
        private string spinReel()
        {
            ...
            "Diamond", "HorseShoe", "Lemon", "Orange", "Plum", "Seven", "Strawberry",
            "Watermellon"};
